...
Note: While loop is on LN 111 (OptionButton function).
...
namespace MB_Final_CSC202_07_10_24
{
    public partial class Form1 : Form
    {
        ...
        public void OptionButton(string[] text) // Function for feedback user input on  North and south area.
        {
            ...
            // While true loop, if nothing is inputted when user click on submit button, then it will prompt message box.
            while(true)
            {
                

                if (FeedbackTxtbx.Text.Length != 0)
                {
                ...
                {
                    MessageBox.Show("Need to input something");
                }

                if (stxBox.Text.Length != 0)
                {
                    text[1] = stxBox.Text;
        ...
        // This button clears the answer box.
        private void STHCLRbutton_Click(object sender, EventArgs e)
        {
            STHANSWRtxtbx.Text = string.Empty;
        }
        // This button clears the answer box.
        private void NRTHCLRbutton_Click(object sender, EventArgs e)
        {
            FDBKANSWRTxtbx.Text = string.Empty;
        }
    }
}
